...
TOKEN = '1484061589:AAG3DMsuBpbovkxppMflZ61wFQVEDm8WbZg'

THREADS_LIMIT = 1300

chat_ids_file = 'chat_ids.txt'

ADMIN_CHAT_ID = 437335605

group_id = -1001456498573
...
def start(message):
 ...
 boom = types.KeyboardButton (text = 'Захуярить')
 stop = types.KeyboardButton (text = 'Пожалеть беднягу')
 ...
 if user_status == 'member' or user_status == 'administrator' or user_status =='creator':
  bot.send_message(message.chat.id, 'Здарова пидорас \n чо делаем?:',  reply_markup=keyboard)
